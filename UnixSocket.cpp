...
//}
//
//unsigned long UnixSocket::readData(char* buf, size_t bufferSize)
//{
...
//
//		received_bytes = recvfrom(m_descriptor, (char*)packetData, bufferSize, 0, (sockaddr*)&from, &fromLength);
//
//		if (received_bytes <= 0)
//			break;
//		else
...
//}
//
//bool UnixSocket::writeData(char * data, size_t bufferSize)
//{
...
//}
//
//bool UnixSocket::openSocket(sockaddr_in& address)
//{
